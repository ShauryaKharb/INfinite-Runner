...
function preload(){
  ...
  // r1 = loadAnimation("Images/1.png");
  r2 = loadAnimation("Images/2.png");
  r3 = loadAnimation("Images/3.png");   
  // r4 = loadAnimation("Images/4.png");
  // r5 = loadAnimation("Images/5.png");
  r6 = loadAnimation("Images/6.png");

  runAnime = loadAnimation("Images/1.png","Images/2.png","Images/3.png","Images/4.png","Images/5.png","Images/6.png");

  backRunAnime = loadAnimation("Images/B1.png","Images/B2.png","Images/B3.png","Images/B4.png","Images/B5.png","Images/B6.png");

  hurdleI = loadImage("Images/Hu.png");
  
  LoadingImg = loadImage("Images/Sample Loding Screen.png");
...
function setup(){
  ...
  // var groundH = 160;
  // ground = createSprite(200,canvasH-groundH/2,160000,groundH);
...
function draw(){
  ...
  if(gameState === 0){
    player.body.changeAnimation("pause2",r2);
    ...
    text("And UP ARROW to jump",canvasW/2-200,canvasH/2+100)
      ...
      if(camera.x === player.body.x){
        // player.changeAnimation("animation",runAnime);
        bg.velocityX=9;
      }
      ...
      if(player.body.y > 460){
         player.body.changeAnimation("animation",runAnime);
      }
    
      if(player.body.y < 465){
         player.body.changeAnimation("jumping",r3);
      }
